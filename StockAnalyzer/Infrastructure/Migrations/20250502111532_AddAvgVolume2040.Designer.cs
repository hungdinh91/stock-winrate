...
namespace StockAnalyzer.Infrastructure.Migrations
{
    ...
    [Migration("20250502111532_AddAvgVolume2040")]
    partial class AddAvgVolume2040
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockAnalyzer.Domain.Entities.StockPrice", b =>
                {
                    ...
                    b.Property<long>("AvgVolume40")
                        .HasColumnType("bigint");

                    b.Property<long>("AvgVolume60")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StockAnalyzer.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<decimal>("BeforeWinLossInPercent")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("HoldingOriginalCash")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("HoldingWinLossInPercent")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("StockAnalyzer.Domain.Entities.WinRate", b =>
                {
                    ...
                    b.Property<decimal>("BalanceAfter11Year")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("BalanceAfter12Year")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("BalanceAfter13Year")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("BalanceAfter14Year")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("BalanceAfter15Year")
                        .HasColumnType("decimal(18,2)");
